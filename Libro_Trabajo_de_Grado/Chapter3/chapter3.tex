...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.85\linewidth]{Figuras/gas_npe_fraccion}
	\caption[Fracción de neutrones en el gas ideal degenerado]{Fracción de neutrones respecto al número de nucleones $n_n/n_B$ como función de la densidad bariónica $n_B$ en un gas ideal degenerado de neutrones, protones y electrones.}
	\label{fig:gas_npe_fraccion}
\end{figure}

La figura \ref{fig:eosnpe} muestra la ecuación de estado adimensionalizada para un gas ideal de neutrones, protones y electrones libres, obtenida tras resolver el sistema de integrales (\ref{eq:densidad_fermi_general}) y (\ref{eq:presion_fermi_general}) e interpolar. Adicionalmente, se puede calcular la fracción de neutrones respecto al número total de nucleones (bariones) $n_n/n_B = n_n/(n_n+n_p)$ como función de la densidad bariónica $n_B$, como se muestra en la figura \ref{fig:fraccion_neutrones}. Este modelo predice que la materia en equilibrio beta es predominantemente neutrónica, con una fracción de neutrones que supera el 90\% para densidades entre $7\times 10^{12}$ g/cm$^3$ y $10^{15}$ g/cm$^3$. La fracción de neutrones en este rango de densidades inicia muy cercana al 1, disminuyendo lentamente a medida que la densidad aumenta, alcanzando aproximadamente un 90.5\% al llegar a $10^{17}$ g/cm$^3$, consistente con lo esperado para materia nuclear en equilibrio beta \cite{shapiroBlackHolesWhite2008}.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.85\linewidth]{Figuras/gas_npe_MR}
