...
Finalmente, se realizó una comprobación de los criterios de aceptabilidad física para el caso particular de los parámetros en (\ref{eq:params_glendenning}) que puede consultarse en el Apéndice \ref{apendice:aceptabilidad}. Como era de esperarse por su construcción covariante, una estrella de neutrones obtenida con este conjunto de parámetros cumple con todos los criterios de aceptabilidad física establecidos en la literatura \cite{ospinoRelativisiticNonpascalianFluid2025, hernandezAcceptabilityConditionsRelativistic2021}, salvo la condición de estabilidad ante convección que satisface en el 97\% de la estrella, por lo que se considera aceptable. Se espera que las demás configuraciones encontradas en este estudio también cumplan con estos criterios, dado que sus ecuaciones de estado son similares en rigidez y comportamiento al conjunto de parámetros de referencia. No obstante, una verificación exhaustiva de estos criterios para todas las configuraciones obtenidas queda fuera del alcance del presente trabajo y se deja como una posible actividad futura.